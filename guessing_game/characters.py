...
boring game; a line-up nobody would ever put in the same sentence makes a
...
Meowth. Mixing real people with fictional ones in the same game is
...
def generate(category: str, model: str, avoid: list[str], count: int = 2) -> list[Pick]:
    if count < 2:
        raise GenerationError("A game needs at least two characters.")
